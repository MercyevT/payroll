#pragma checksum "C:\Users\max_w\Desktop\projectpayroll\Views\Clocking\index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9624ed15a955071d7210182b5456f9985e496f86"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9624ed15a955071d7210182b5456f9985e496f86", @"/Views/Clocking/index.cshtml")]
        ...
        <v-main>
            ...
            WriteLiteral(@"@click='clocking_i'>
                      ...
                      <v-list-group
                        ...
                        <v-list-item-title style=""color:white"">WORKING TIME</v-list-item-title>
                        </v-list-item>

                              <v-list-item ");
            WriteLiteral("@click=\'all_wk\'>\n                                <v-list-item-title  style=\"color:white\">ALL</v-list-item-title>\n                            </v-list-item>\n                            <v-list-item ");
            WriteLiteral(@"@click='add_wk'>
                                <v-list-item-title  style=""color:white"">NEW WORKINGTIME</v-list-item-title>
                            </v-list-item>
                        </v-list-group>
            ...
            <div class=""size"">       
            <h3 style=""text-align:center"">CLOCKING SUMMARY</h3>
        ...
        >
          ...
          <v-btn
            ...
            WriteLiteral(@"@click='add_data'
              style=""background-color:#002952; color:white;""
             >
                 Search    
             </v-btn>
             <template>
      ...
      <v-col cols=""12"">
            <v-card class=""ma-2"">
                    <v-card-title class=""dark--text"" style=""background-color:#001f3d;"">
                        <h3 style=""text-align: center; color:white"">Employee Attendance Time</h3>
                    </v-card-title>
                    <v-card-text>
             ...
             />
    ");
            WriteLiteral("              <template v-slot:item.actions=\'{item}\'>\n                        <v-btn \n                        class=\"white--text\"\n                        color=\"blue darken-1\"\n                        ");
...
");
  ...
  ");
                WriteLiteral("                  },\n                    mini:true,\n                }//edata\n                ,\n                created(){\n                    this.clockings = ");
#nullable restore
#line 315 "C:\Users\max_w\Desktop\projectpayroll\Views\Clocking\index.cshtml"
...
#nullable disable
                WriteLiteral(";\n                    this.workingTimes = ");
#nullable restore
#line 316 "C:\Users\max_w\Desktop\projectpayroll\Views\Clocking\index.cshtml"
...
#nullable disable
                WriteLiteral(";\n                    this.departments = ");
#nullable restore
#line 317 "C:\Users\max_w\Desktop\projectpayroll\Views\Clocking\index.cshtml"
...
#nullable disable
                ...
                methods:{
                    ...
                    add_data(){
                      this.work1=[];
                       this.work2=[];
                       this.work3=[];
                       this.itemX=[""On Time(Le");
                WriteLiteral(@"ss than ""+this.on+"" minutes)"",""Less than ""+this.late+"" minutes"",""more than ""+this.late+"" minutes""];
                       this.itemY=[];
                ...
                WriteLiteral(@"  for(i=0;i<this.clocking.length;i++){
                          ...
                          else if(this.clocking[i].departme");
                WriteLiteral(@"ntId==this.workingTimes[a].departmentId
                              &&this.clocking[i].clockingIn.split("":"")[0]==this.workingTimes[a].start.split("":"")[0]
                              &&parseInt(this.clocking[i].clockingIn.split("":"")[1])>this.late
                ...
                WriteLiteral(@"            else if(a.employeeId == b.employeeId) return 0; 
                    ...
                    this.plot.series=[{
                            ...
                            data: this.itemY,
");
                WriteLiteral(@"                            itemStyle: { color: '#8C001A'
                            }
                        }];
                    ...
                    check(){
                      ...
                      add_wk(){
                        ");
                WriteLiteral(" window.location=\'/workingtime/add\'\n                      }\n\n                }//emethods\n                ,\n                computed:{\n\n                }//ecomputed\n            };\n            app = new Vue(component);\n\n\n    </script>\n\n");
            }
            );
        }
